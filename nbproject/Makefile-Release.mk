...
LDLIBSOPTIONS=-L/Applications/root_v6.14.06/lib
...
${OBJECTDIR}/ChannelConvolutionPdf.o: ChannelConvolutionPdf.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChannelConvolutionPdf.o ChannelConvolutionPdf.cpp

${OBJECTDIR}/Constants.o: Constants.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Constants.o Constants.cpp

${OBJECTDIR}/ConvPdf.o: ConvPdf.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConvPdf.o ConvPdf.cpp

${OBJECTDIR}/ExpPdf.o: ExpPdf.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExpPdf.o ExpPdf.cpp

${OBJECTDIR}/FileUtils.o: FileUtils.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileUtils.o FileUtils.cpp

${OBJECTDIR}/GrainPdf.o: GrainPdf.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GrainPdf.o GrainPdf.cpp

${OBJECTDIR}/MyConvPdf.o: MyConvPdf.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyConvPdf.o MyConvPdf.cpp

${OBJECTDIR}/MyPdf.o: MyPdf.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyPdf.o MyPdf.cpp

${OBJECTDIR}/MyPdfCache.o: MyPdfCache.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyPdfCache.o MyPdfCache.cpp
...
${OBJECTDIR}/StructParams.o: StructParams.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StructParams.o StructParams.cpp

${OBJECTDIR}/ThreeExpPdf.o: ThreeExpPdf.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ThreeExpPdf.o ThreeExpPdf.cpp

${OBJECTDIR}/ThreeGaussian.o: ThreeGaussian.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ThreeGaussian.o ThreeGaussian.cpp

${OBJECTDIR}/TrapPdf.o: TrapPdf.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TrapPdf.o TrapPdf.cpp

${OBJECTDIR}/TwoExpPdf.o: TwoExpPdf.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TwoExpPdf.o TwoExpPdf.cpp

${OBJECTDIR}/TwoGaussian.o: TwoGaussian.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TwoGaussian.o TwoGaussian.cpp

${OBJECTDIR}/positronfit.o: positronfit.cc
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/Applications/root_v6.14.06/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/positronfit.o positronfit.cc
