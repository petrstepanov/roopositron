...
ThreeGaussian::ThreeGaussian(const char *name, const char *title, RooAbsReal& _x, RooAbsReal& _mean, RooAbsReal& _sigma1, RooAbsReal& _sigma2, RooAbsReal& _sigma3, RooAbsReal& _i2,
		RooAbsReal& _i3) :
		RooAbsPdf(name, title), x("x", "Observable", this, _x), mean("mean", "mean", this, _mean), sigma1("sigma1", "Width1", this, _sigma1), sigma2("sigma2", "Width2", this, _sigma2), sigma3(
				"sigma3", "Width3", this, _sigma3), i2("i2", "I2", this, _i2), i3("i3", "I3", this, _i3) {
}

ThreeGaussian::ThreeGaussian(const ThreeGaussian& other, const char* name) :
		RooAbsPdf(other, name), x("x", this, other.x), mean("mean", this, other.mean), sigma1("sigma1", this, other.sigma1), sigma2("sigma2", this, other.sigma2), sigma3("sigma3", this, other.sigma3), i2(
				"i2", this, other.i2), i3("i3", this, other.i3) {
}

// Evaluate without normalization
Double_t ThreeGaussian::evaluate() const {
	Double_t arg1 = x - mean;
	Double_t arg2 = x - mean;
