...
(3*(Power(E,(-16*Power(Pi,2)*t)/Power(L,2))+Power(E,(-9*Power(Pi,2)*t)/Power(L,2))+
Power(E,(-4*Power(Pi,2)*t)/Power(L,2))+Power(E,-(Power(Pi,2)*t)/Power(L,2)))*Pps)/
(2.*Power(E,lPs*t)*Power(L,2))+(lPs*(1+
(-205+9/Power(E,(16*Power(Pi,2)*t)/Power(L,2))+16/Power(E,(9*Power(Pi,2)*t)/Power(L,2))+
36/Power(E,(4*Power(Pi,2)*t)/Power(L,2))+144/Power(E,(Power(Pi,2)*t)/Power(L,2)))/(24.*Power(Pi,2)))*Pps
)/Power(E,lPs*t)+(900000*Power(E,(-0.007-6.64/L-
(200000*(1+0.7611940298507462/Power(E,(1600000*t)/(L*Mr)))*mu)/
((1-0.7611940298507462/Power(E,(1600000*t)/(L*Mr)))*L))*t)*
(1+0.7611940298507462/Power(E,(1600000*t)/(L*Mr)))*mu*Pps*
((-1+Power(E,t*((120.20294315356591+Power(L,2)*(-0.005328358208955224+0.7611940298507462*lPs)+
L*(-5.054328358208955+152238.80597014926*mu)+
Power(E,(1600000*t)/(L*Mr))*(-157.91367041742973+Power(L,2)*(0.007-1.*lPs)+
L*(6.64+200000.*mu)))/((-0.7611940298507462+Power(E,(1600000*t)/(L*Mr)))*Power(L,2)))))/
((120.20294315356591+Power(L,2)*(-0.005328358208955224+0.7611940298507462*lPs)+
L*(-5.054328358208955+152238.80597014926*mu)+
Power(E,(1600000*t)/(L*Mr))*(-157.91367041742973+Power(L,2)*(0.007-1.*lPs)+L*(6.64+200000.*mu)))
/((-0.7611940298507462+Power(E,(1600000*t)/(L*Mr)))*Power(L,2)))+
((-1+Power(E,t*((7*Power(Pi,2))/Power(L,2)+
((120.20294315356591+Power(L,2)*(-0.005328358208955224+0.7611940298507462*lPs)+
L*(-5.054328358208955+152238.80597014926*mu)+
Power(E,(1600000*t)/(L*Mr))*
(-157.91367041742973+Power(L,2)*(0.007-1.*lPs)+L*(6.64+200000.*mu)))/
((-0.7611940298507462+Power(E,(1600000*t)/(L*Mr)))*Power(L,2))))))*Power(L,2))/
(7*Power(Pi,2)+Power(L,2)*((120.20294315356591+
Power(L,2)*(-0.005328358208955224+0.7611940298507462*lPs)+
L*(-5.054328358208955+152238.80597014926*mu)+
Power(E,(1600000*t)/(L*Mr))*(-157.91367041742973+Power(L,2)*(0.007-1.*lPs)+
L*(6.64+200000.*mu)))/((-0.7611940298507462+Power(E,(1600000*t)/(L*Mr)))*Power(L,2))))+
((-1+Power(E,t*((12*Power(Pi,2))/Power(L,2)+
((120.20294315356591+Power(L,2)*(-0.005328358208955224+0.7611940298507462*lPs)+
L*(-5.054328358208955+152238.80597014926*mu)+
Power(E,(1600000*t)/(L*Mr))*
(-157.91367041742973+Power(L,2)*(0.007-1.*lPs)+L*(6.64+200000.*mu)))/
((-0.7611940298507462+Power(E,(1600000*t)/(L*Mr)))*Power(L,2))))))*Power(L,2))/
(12*Power(Pi,2)+Power(L,2)*((120.20294315356591+
Power(L,2)*(-0.005328358208955224+0.7611940298507462*lPs)+
L*(-5.054328358208955+152238.80597014926*mu)+
Power(E,(1600000*t)/(L*Mr))*(-157.91367041742973+Power(L,2)*(0.007-1.*lPs)+
L*(6.64+200000.*mu)))/((-0.7611940298507462+Power(E,(1600000*t)/(L*Mr)))*Power(L,2))))+
((-1+Power(E,t*((15*Power(Pi,2))/Power(L,2)+
((120.20294315356591+Power(L,2)*(-0.005328358208955224+0.7611940298507462*lPs)+
L*(-5.054328358208955+152238.80597014926*mu)+
Power(E,(1600000*t)/(L*Mr))*
(-157.91367041742973+Power(L,2)*(0.007-1.*lPs)+L*(6.64+200000.*mu)))/
((-0.7611940298507462+Power(E,(1600000*t)/(L*Mr)))*Power(L,2))))))*Power(L,2))/
(15*Power(Pi,2)+Power(L,2)*((120.20294315356591+
Power(L,2)*(-0.005328358208955224+0.7611940298507462*lPs)+
L*(-5.054328358208955+152238.80597014926*mu)+
Power(E,(1600000*t)/(L*Mr))*(-157.91367041742973+Power(L,2)*(0.007-1.*lPs)+
L*(6.64+200000.*mu)))/((-0.7611940298507462+Power(E,(1600000*t)/(L*Mr)))*Power(L,2))))))/
((1-0.7611940298507462/Power(E,(1600000*t)/(L*Mr)))*Power(L,3))+
(9*Power(E,(-0.007-6.64/L-(200000*(1+0.7611940298507462/Power(E,(1600000*t)/(L*Mr)))*mu)/
((1-0.7611940298507462/Power(E,(1600000*t)/(L*Mr)))*L))*t)*
(0.007+6.64/L+(200000*(1+0.7611940298507462/Power(E,(1600000*t)/(L*Mr)))*mu)/
