...
//    mu("mu", this, other.mu)
    ...
    RooRealVar* tauPs = new RooRealVar("tauPs", "Ps lifetime in vacancy", 0.180, 0.180, 0.180, "ns");
    RooFormulaVar* lambdaPs = new RooFormulaVar("lambdaVac", "1/@0", *tauPs);
    RooFormulaVar* lambdaPsCh = new RooFormulaVar("lambdaVacCh", "@0*@1", RooArgList(*lambdaPs, *channelWidth));
    ...
    return new PowderPdf("powder", "Powder model", *observable, *L, *kappaVacCh, *P_Ps, *lambdaBulkCh, *lambdaVacCh, *lambdaPsCh, *Mratio, *mu);
}
