...
//	}
	...
	return new ThreeGaussian("threeGaussPDF", "Three gauss resolution function", *observable, *gMean, *g1Dispersion, *gMean, *g2Dispersion, *g3Dispersion, *g2Fraction, *g3Fraction);	
}
