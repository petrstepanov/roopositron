...
RooAbsPdf* ThreeGaussProvider::initPdf(int i) {
    ...
    // 1st Gauss FWHM
    RooRealVar* g1FWHM = new RooRealVar("gauss1FWHM", "1st gauss FWHM", 0.3, 0.1, 0.4, "ns");
    RooFormulaVar* g1Dispersion = new RooFormulaVar("gauss1Dispersion", "@0*@1/@2", RooArgList(*g1FWHM, *fwhm2disp, *channelWidth));

    // 2nd gauss FWHM
    RooRealVar* g2FWHM = new RooRealVar("gauss2FWHM", "2nd gauss FWHM", 0.8, 0.4, 1.5, "ns");
    RooFormulaVar* g2Dispersion = new RooFormulaVar("gauss2Dispersion", "@0*@1/@2", RooArgList(*g2FWHM, *fwhm2disp, *channelWidth));

    // 3nd gauss FWHM
    RooRealVar* g3FWHM = new RooRealVar("gauss3FWHM", "3rd gauss FWHM", 1.5, 0.8, 3.0, "ns");
	...
	RooRealVar* g3Fraction = new RooRealVar("gauss3Frac", "3rd gauss fraction", 1, 0, 10, "%");
